...
import 'package:tflite_flutter_helper_plus/src/task/bindings/text/nl_classifier/types.dart';
...
class NLClassifierOptions {
  ...
  static const defaultinputtensorname = "INPUT";
  static const defaultoutputscoretensorname = "OUTPUT_SCORE";
  // By default there is no output label tensor. The label file can be attached
  // to the output score tensor metadata.
  static const defaultoutputlabeltensorname = "OUTPUT_LABEL";
  static const defaultinputtensorindex = 0;
  static const defaultoutputscoretensorindex = 0;
  static const defaultoutputlabeltensorindex = -1;

  /// Creates a new options instance.
  factory NLClassifierOptions() {
    final optionsPtr = TfLiteNLClassifierOptions.allocate(
        defaultinputtensorindex,
        defaultoutputscoretensorindex,
        defaultoutputlabeltensorindex,
        defaultinputtensorname,
        defaultoutputscoretensorname,
        defaultoutputlabeltensorname);
